...
class TestRegistration:
    def test_user_can_register_with_new_email(self, registered_driver):
    ...
    def test_user_cant_register_with_bad_email(self, fail_registered_driver):
    ...
    def test_registered_already_user(self, registered_driver_with_already_user):
